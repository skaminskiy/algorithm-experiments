...
public class Insertion {
     public static void main(String[] args) {
            ...
            System.out.println(Integer.toBinaryString(insert(0b10000000000, 0b10011, 2, 6))); //10001001100
            System.out.println(Integer.toBinaryString(insert(0b10101110101, 0b10011, 2, 6))); //10101001101
     }
